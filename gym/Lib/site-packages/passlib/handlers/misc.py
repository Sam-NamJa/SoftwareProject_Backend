...
class unix_disabled(uh.ifc.DisabledHash, uh.MinimalHandler):
    ...
    This class does not implement a hash, but instead matches the "disabled accounts"
    strings found in ``/etc/shadow`` on most Unix variants. "encrypting" a password
    will simply return the disabled accounts marker. It will reject all passwords,
    ...
    :param marker:
        ...
        used to indicate a disabled accounts.
