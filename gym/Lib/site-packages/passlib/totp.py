...
class TOTP(object):
    ...
    def using(cls, digits=None, alg=None, period=None,
        ...
        def norm_param(attr, value):
            ...
            #       so normalization takes into accounts any custom params
            #       already stored.
...
#            counter += 1
    ...
    def match(self, token, time=None, window=30, skew=0, last_counter=None):
        ...
        in order to accounts for transmission delay and small amounts of skew in the client's clock.
        ...
        :param int skew:
            Adjust timestamp by specified value, to accounts for excessive
            ...
            The **window** parameter is usually enough to accounts
